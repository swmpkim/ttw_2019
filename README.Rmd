...
Choose your own adventure on this - bring Excel files straight off your EXOs, and bring a handful of `---_QC.csv` WQ and MET files that are automatically emailed when you upload raw data to the CDMO. Data from Grand Bay will be provided, but it's always more fun to work with your own!
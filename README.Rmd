...
The first one to run is:  `00a_package_installation.R`:  [click here](https://github.com/swmpkim/ttw_2019/blob/master/00a_package_installation.R); copy and paste that script into RStudio, and follow the instructions at the top.  

After that has finished, run `00b_package_check.R` to make sure all packages installed properly;  [click here](https://github.com/swmpkim/ttw_2019/blob/master/00b_package_check.R); copy and paste that script into RStudio, and follow the instructions at the top.  
